...
class Text extends Equatable {
  ...
  factory Text.light() => const Text(
        ...
        textSecondary: Color(0xFF91919B),
      );
...
class Primary extends Equatable {
  ...
  const Primary({required this.primary, required this.secondary});

  factory Primary.light() =>
      const Primary(primary: Color(0xff0966C2), secondary: Color(0xFFED4850));
